...
import com.indivaragroup.expression.ExpressionStatement;
import com.indivaragroup.house.floor.dto.Ceramic;
import com.indivaragroup.operator.*;
import com.indivaragroup.task.grading.GradingIf;
import com.indivaragroup.task.housing.CreditSystem;
import com.indivaragroup.task.parking.ParkSystem;
...
//        ui.start();
        ...
        AugmentedAssignment augmentedAssignment = new AugmentedAssignment();
        augmentedAssignment.runDemonstration();

        System.out.println("\n=============CMPRE==============\n");

        ComparisonOperator comparisonOperator = new ComparisonOperator();
        comparisonOperator.runDemonstration();

        System.out.println("\n=============UNARY==============\n");

        UnaryStatement unaryStatement = new UnaryStatement();
        unaryStatement.runDemonstration();

        System.out.println("\n=============BTWSE==============\n");

        BitwiseOperator bitwiseOperator = new BitwiseOperator();
        bitwiseOperator.runDemonstration();

        System.out.println("\n=============BOOLN==============\n");

        BooleanOperator booleanOperator = new BooleanOperator();
        booleanOperator.runDemonstration();

        System.out.println("\n=============INSTC==============\n");

        InstanceOperator instanceOperator = new InstanceOperator();
        instanceOperator.runDemonstration();

        System.out.println("\n=============EXPRS==============\n");

        ExpressionStatement expressionStatement = new ExpressionStatement();
        expressionStatement.runDemonstration();

        System.out.println("\n=============GRDE2==============\n");

        GradingIf gradingIf = new GradingIf();
        gradingIf.runGrading();

        System.out.println("\n=============EL-IF==============\n");

        ElseIfStatement elseIfStatement = new ElseIfStatement();
        elseIfStatement.runDemonstration();

        System.out.println("\n=============PARKG==============\n");

        ParkSystem parkSystem = new ParkSystem();
        parkSystem.runMetering();

        System.out.println("\n=============CRDIT==============\n");

        CreditSystem creditSystem = new CreditSystem();
        creditSystem.runCalculation();

        System.out.println("\n=============SWCSE==============\n");

        SwitchStatement switchStatement = new SwitchStatement();
        switchStatement.runDemonstration();
